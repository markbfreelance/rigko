...
export default function ChassisFrame() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[100] flex flex-col md:block">
      ...
      <div className="absolute top-0 left-0 w-full h-16 md:h-20 chassis-steel border-b-2 border-black/10 dark:border-black/40 z-20">
      ...
      {/* Left Frame Pillar */}
      <div className="hidden lg:block absolute top-0 left-0 w-12 h-full chassis-steel border-r-2 border-black/10 dark:border-black/40">
      ...
      {/* Right Frame Pillar */}
      <div className="hidden lg:block absolute top-0 right-0 w-12 h-full chassis-steel border-l-2 border-black/10 dark:border-black/40">
        <div className="flex flex-col items-center gap-24 py-32 opacity-30">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="w-6 h-px bg-white/20"></div>
          ))}
