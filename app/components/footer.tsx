...
export default function Footer() {
  return (
    <footer className="w-full chassis-steel pt-16 pb-[calc(4rem+env(safe-area-inset-bottom))] lg:pb-[calc(4rem+env(safe-area-inset-bottom))] relative z-[110] border-t-2 border-[var(--chassis-border)]">
