                  ...
                  <div className="p-4 rounded-xl border border-[#e5e5e5] dark:border-[#222222] relative overflow-hidden isolate">
                    ...
                    <div className="relative z-10 grid grid-cols-3 gap-y-8 gap-x-4">
                      ...
                      return (
                        ...
                        >
                          <div className={`relative shrink-0 w-12 h-12 min-w-[48px] min-h-[48px] rounded-xl flex items-center justify-center border-2 transition-all shadow-md group/iconbox ${
                            sel 
                            ...
                            >
                              <div className="pt-2">
                                  <div className="w-full flex items-start gap-2 transition-all group/row">
                                    ...
                                    <div className={`relative shrink-0 w-12 h-12 min-w-[48px] min-h-[48px] flex flex-col items-center justify-center rounded-xl border-2 transition-all ${
                                      isActive
                                      ...
                                      <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-1 h-3 bg-gray-400 dark:bg-gray-600 rounded-full"></div>
                                      <Icon icon={pcat.icon} className={`text-xl transition-all ${
                                        sel ? "text-[#c2000b]" : isActive ? "text-[#c2000b]" : "text-gray-500"
                                      }`} />
                                    </div>

                                    {/* Block 2: The Details Container (2 Pins) */}
                                    <div className={`relative flex-1 flex flex-col rounded-xl border-2 transition-all ${
                                      isActive
                                      ? "bg-white dark:bg-[#1a1a1a] border-[#c2000b] shadow-[0_4px_12px_rgba(194,0,11,0.1)]"
                                      : "bg-white dark:bg-[#1a1a1a] border-[#e5e5e5] dark:border-[#222222] group-hover/row:border-[#c2000b]/30"
                                    }`}>
                ...
                <div className="relative z-10 grid grid-cols-3 gap-y-8 gap-x-2">
                  ...
                  return (
                    <button 
                      ...
                      className="flex flex-col items-center gap-2 group relative"
                    >
                      <div className={`relative shrink-0 w-11 h-11 min-w-[44px] min-h-[44px] rounded-xl flex items-center justify-center border-2 transition-all shadow-md group/iconbox ${
                        sel 
                        ? "bg-[#c2000b] border-[#ff4d4d] text-white shadow-[0_0_15px_rgba(194,0,11,0.3)]" 
                        : isActive
                        ? "bg-white dark:bg-[#1a1a1a] border-[#c2000b] text-[#c2000b]"
                      ...
                      return (
                        ...
                        >
                          <div className="pt-2">
                            <div className="w-full flex items-start gap-2 transition-all group/row">
                              {/* Block 1: The Icon (1 Pin) */}
                              <div className={`relative shrink-0 w-11 h-11 min-w-[44px] min-h-[44px] flex flex-col items-center justify-center rounded-xl border-2 transition-all ${
                                isActive
                                ? "bg-white dark:bg-[#1a1a1a] border-[#c2000b] shadow-[0_4px_12px_rgba(194,0,11,0.1)]"
                                : "bg-white dark:bg-[#1a1a1a] border-[#e5e5e5] dark:border-[#222222] group-hover/row:border-[#c2000b]/30"
                              }`}>
