...
export default function HeroHome() {
  return (
    <section className="relative w-full min-h-[95vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      {/* Background Ambience */}
      <div className="absolute inset-0 bg-linear-to-b from-[#fdfdfd] via-transparent to-[#fdfdfd] dark:from-black dark:to-black z-0 pointer-events-none transition-colors"></div>
        ...
        <div className="reveal text-center relative w-full flex flex-col items-center">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-8 w-full pointer-events-none transition-colors">
              <Link href="/build" className="bg-[#c2000b] text-white px-12 py-5 rounded-full text-lg font-bold hover:bg-[#8b0000] transition-all transform hover:scale-105 shadow-2xl shadow-[#c2000b]/40 pointer-events-auto">
                BUILD YOUR RIG
              </Link>
      ...
      {/* Mobile-specific Bokeh Blur Overlay (Blurs parts near edges, keeps center clear) */}
      <div className="absolute inset-0 md:hidden dark:hidden z-8 pointer-events-none [backdrop-filter:blur(1px)] mask-[radial-gradient(circle_at_center,transparent_10%,black_10%)] [-webkit-mask-image:radial-gradient(circle_at_center,transparent_10%,black_10%)]"></div>
